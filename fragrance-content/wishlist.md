# Perfumes I Want to Buy

Perfumes on the radar but not owned yet. **Only added here when you explicitly say to add
something** — recommendations given in chat are not added automatically, even if you seem
interested.

| Perfume | Brand | Notes/Accords | Why it's on the list | Priority |
|---|---|---|---|---|
| Tenerife | Superz. | Sweet notes, citruses, white flowers, aromatic notes, vanilla, aromatic spices, amber | Sweet, citrus-forward opening over a vanilla-amber base — bridges your gourmand favorites with the fresher scents you've been gravitating toward lately | High |
